...
//     // Variables to hold the LED index.
//     uint8_t row = 0;
//     uint8_t col = 0;
//     bool valid_key = false;
    
//     // Determine which key was pressed/released and extract row/column info.
//     switch (keycode) {
//         case K00: row = 0; col = 0; valid_key = true; break;
...
//     if (valid_key) {
//         uint8_t led_index = led_mapping[row][col];
//         if (record->event.pressed) {
//             // Set the LED to a color when key is pressed (e.g., green)
//             rgblight_setrgb_at(0, 255, 0, led_index);
//         } else {
